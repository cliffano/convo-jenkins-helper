const _ = require('underscore');
  ...
  * NOTE: if this function needs to also support build with parameters as part of a different conversation,
  * it can use convoOpts to identify the conversation name and distinguish the conversations accordingly
  *
